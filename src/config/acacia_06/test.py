...
args = dict(
    ...
    save_dir=os.path.join(model_dir.replace('fold=XYZ',''), '{args[dataset][kwargs][type]}_results{args[eval_epoch]}-{args[center_checkpoint_name]}--thr{args[center_model][kwargs][local_max_thr]}'),
