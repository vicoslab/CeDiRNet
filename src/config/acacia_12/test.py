...
args = dict(
    ...
    eval=dict(
        ...
        centers_global_minimization_for_patch_merge=dict(
            display_best_threshold=False,
            tau_thr=[40],  # 40 == used in paper "Counting trees with point-wise supervised segmentation network" by Tong et al.
            merge_threshold_px=40,  # 40 == used in paper "Counting trees with point-wise supervised segmentation network" by Tong et al.
